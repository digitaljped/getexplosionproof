...
schema:
  ...
  "mainEntity":
    - "@type": "Question"
      "name": "What is purge and pressurization for explosion-proof buildings?"
      "acceptedAnswer":
        "@type": "Answer"
        "text": "Purge and pressurization under NFPA 496 is a code-compliant method that declassifies the interior of a building in a hazardous location by maintaining positive air pressure with clean above-grade intake air. This allows standard non-explosion-proof equipment to be used inside the building, with only the outdoor condenser requiring explosion-proof rating."
    - "@type": "Question"
      "name": "How much does a pressurization system cost compared to full explosion-proof buildout?"
      "acceptedAnswer":
        "@type": "Answer"
        "text": "A complete pressurization system typically costs $25,000 to $50,000 depending on building size and complexity. For comparison, a full explosion-proof buildout for a mid-size equipment shelter can run $150,000 to $200,000 in XP-rated equipment alone. About 20 to 25 percent of customers choose pressurization because the system pays for itself many times over by eliminating the need for explosion-proof equipment throughout the building interior."
    - "@type": "Question"
      "name": "Can pressurization be added to an existing building or unit?"
      "acceptedAnswer":
        "@type": "Answer"
        "text": "Yes. Pressurization can be added to any existing air conditioning unit or supplied as a standalone pressurization module. Retrofitting into an existing structure requires evaluation of the building envelope including sealing penetrations and qualifying door seals. New builds designed for pressurization from the start are simpler and less expensive."
    - "@type": "Question"
      "name": "What are the NFPA 496 protection types X, Y, and Z?"
      "acceptedAnswer":
        "@type": "Answer"
        "text": "Type X reduces classification from Division 1 to nonhazardous and requires automatic de-energization on pressure loss. Type Y reduces from Division 1 to Division 2 and requires an alarm but not automatic de-energization. Type Z reduces from Division 2 to nonhazardous and requires an alarm. For full-building pressurization in Division 1 areas, Type X is typically required."
---
...
![Pressurized equipment shelter at a petrochemical facility, showing galvanized snorkel duct rising approximately 20 feet above the container, wall-mount AC unit, and red pressurization loss alarm horn](/images/site/pressurization-snorkel-installation.jpg)
...
**[Request a Quote](/get-a-quote/)** — or call us directly. Our specialists handle classified-area applications every day. There's no long intake form, no waiting for a distributor to relay your question. You're talking to the people who build the system.
