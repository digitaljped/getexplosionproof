...
schema:
  ...
  "@type": "HowTo"
  "name": "How to Choose an Explosion Proof Air Conditioner"
  "description": "Step-by-step guide to selecting the right explosion-proof air conditioner for your hazardous location."
  "step":
    - "@type": "HowToStep"
      "name": "Determine Your Hazardous Location Classification"
      "text": "Identify your Class, Division, and Group from your facility's HAC drawings. The most common classification is Class 1, Division 2, Groups C & D."
    - "@type": "HowToStep"
      "name": "Size Your Cooling Load"
      "text": "Calculate the BTU or tonnage requirement based on space dimensions, heat-generating equipment, solar exposure, ambient temperature, and desired indoor setpoint."
    - "@type": "HowToStep"
      "name": "Determine Inside-Only vs. Full Modification"
      "text": "Decide whether only the indoor evaporator needs explosion-proof modification (condenser outside classified area) or both sections require modification."
    - "@type": "HowToStep"
      "name": "Choose a Unit Configuration"
      "text": "Select wall-mount, window, split system, or pressurized system based on cooling load and installation constraints."
    - "@type": "HowToStep"
      "name": "Consider Environmental Conditions"
      "text": "Account for corrosive atmospheres, extreme temperatures, vibration, and altitude that affect equipment specification."
    - "@type": "HowToStep"
      "name": "Get a Quote"
      "text": "Call (844) 925-5668 with your classification, BTU requirement, and inside/outside determination. Most quotes return within 24–48 hours."
---
...
If you want the full technical background first, read our [complete guide to explosion-proof air conditioning](/what-is-an-explosion-proof-air-conditioner/).
...
If you do not have HAC drawings, you will need a qualified electrical engineer to classify your area under [NEC Article 500](/nec-500-vs-505/) (or Article 505 if your facility uses the Zone method). This is not something to estimate or guess at. An incorrect classification means the wrong equipment specification, which is both a code violation and a safety hazard.

**What you are looking for:**

**Class** — Is the hazard a flammable gas or vapor ([Class 1](/class-1-division-2/)), combustible dust ([Class 2](/class-2-division-1/)), or ignitable fiber ([Class 3](/class-3-division-1/))?

**Division** — Is the hazard present under normal conditions ([Division 1](/class-1-division-1/)) or only under abnormal conditions ([Division 2](/class-1-division-2/))?
...
See our [full pricing guide](/explosion-proof-air-conditioner-cost/) for a complete breakdown.
...
**[Wall-mount (Bard)](/explosion-proof-bard-air-conditioner/)** — The most common choice for control rooms and equipment buildings. Installs through an exterior wall. Self-contained, compact footprint. Available from fractional tonnage to 5 tons. Our most frequently modified unit. *Choose this for:* most applications under 5 tons where you can cut a wall opening.

**[Mini split](/explosion-proof-mini-split/)** — The most affordable configuration available today. A compact indoor head mounts on a wall or ceiling, with the condenser outside. *Choose this for:* budget-constrained applications up to ~3 tons where you have indoor wall or ceiling space for the evaporator head.

**[Window / through-wall (small)](/explosion-proof-window-air-conditioner/)** — Currently unavailable due to new refrigerant standards. Mini splits have replaced window units as the affordable option.

**[Split system](/explosion-proof-split-system/)** — Indoor and outdoor sections are separate, connected by refrigerant lines. Each section independently rated. *Choose this for:* loads above 5 tons, installations where wall penetration is not possible, or where indoor and outdoor areas have different classifications.

**[Pressurized system](/pressurization-explosion-proof-buildings/)** — Positive air pressure keeps hazardous atmosphere out of the building, allowing standard HVAC inside. *Choose this for:* large buildings where explosion-proofing all interior equipment would be cost-prohibitive. Can save 60–80% on total project cost.

**Quick decision guide:**

- Under 3 tons + budget-sensitive → **[Mini split](/explosion-proof-mini-split/)**
...
- [Class 1, Division 2](/class-1-division-2/) — the most common, oil & gas and petrochemical
- [Class 1, Division 1](/class-1-division-1/) — continuously hazardous gas/vapor areas
- [Class 2, Division 1](/class-2-division-1/) — combustible dust, normal conditions
- [Class 2, Division 2](/class-2-division-2/) — combustible dust, abnormal conditions
- [Class 3, Division 1](/class-3-division-1/) — ignitable fibers and flyings
- [NEC Article 500 vs. 505](/nec-500-vs-505/) — Class/Division vs. Zone classification

Or read our [complete guide to explosion-proof air conditioning](/what-is-an-explosion-proof-air-conditioner/) for the full picture.
