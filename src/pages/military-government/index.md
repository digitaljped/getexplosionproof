...
schema:
  ...
  "mainEntity":
    - "@type": "Question"
      "name": "What documentation do military and government facilities require for explosion-proof air conditioners?"
      "acceptedAnswer":
        "@type": "Answer"
        "text": "Government and military procurement typically requires detailed equipment documentation including specifications, test certifications, country of origin documentation, and compliance records. DOD and DOE projects often require Buy American Act compliance (DFARS) and may have additional documentation requirements for validation and traceability."
    - "@type": "Question"
      "name": "What hazardous location classifications are common at military facilities?"
      "acceptedAnswer":
        "@type": "Answer"
        "text": "Military facilities commonly require Class 1 classifications for fuel storage and distribution (Group D for petroleum vapors), ammunition and explosives storage (which may require Group A or B — the most stringent specifications), and vehicle maintenance areas involving fuel and solvent handling. Naval shipboard applications follow MIL-STD standards that parallel NEC classifications."
    - "@type": "Question"
      "name": "Can you work with government procurement processes and contract vehicles?"
      "acceptedAnswer":
        "@type": "Answer"
        "text": "Yes. We work with both direct government procurement and through prime contractors. We provide detailed technical specifications for procurement documents, letter quotes for budget planning, firm quotes for contract award, and full documentation packages for deliverables."
---
