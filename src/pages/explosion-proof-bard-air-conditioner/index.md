...
We take standard Bard units and re-engineer them to meet the exact hazardous location classification your facility requires — [Class 1](/class-1-division-2/) or [Class 2](/class-2-division-1/), [Division 1](/class-1-division-1/) or Division 2, any group. The modification is not a simple retrofit. It is a systematic replacement of every component that could serve as an ignition source, resulting in a unit that cools the space exactly like the original but cannot ignite the surrounding atmosphere.

![Bard wall-mount air conditioning unit — the most popular base unit for explosion-proof modification](/images/site/wallmount.png)
...
**Motor replacements.** All motors — compressor, condenser fan, evaporator fan — are replaced with explosion-proof rated motors certified for your specific Class, Division, and Group. A motor rated for [Class 1, Division 2, Group D](/class-1-division-2/) is not the same as one rated for [Class 1, Division 1, Group B](/class-1-division-1/) — the engineering requirements differ substantially.
...
- **[Class 1, Division 2, Groups C & D](/class-1-division-2/)** — the most common request. Standard for oil refineries, petrochemical plants, natural gas facilities, and chemical plants where flammable vapors may be present under abnormal conditions. This is where the majority of our Bard modifications land.

- **[Class 1, Division 1, Groups C & D](/class-1-division-1/)** — for areas where flammable gases or vapors are present continuously or under normal operating conditions. Division 1 requires more extensive modification and carries a higher price point.

- **[Class 1, Groups B](/class-1-division-1/)** — for hydrogen-rich environments. Requires higher-rated motors and enclosures. Less common but achievable.

- **[Class 2, Division 1 or 2, Groups E, F, G](/class-2-division-1/)** — for combustible dust environments including grain handling, pharmaceutical manufacturing, coal processing, and certain mining operations.

- **[NEC Article 505 (Zone system)](/nec-500-vs-505/)** — if your facility uses Zone classification instead of Class/Division, we can match equipment to Zone requirements.
...
**Class 1, Division 2, Group C&D — inside only (evaporator):**
Starting at **$6,700** for smaller units, up to **$7,600** for 3-ton units

**Class 1, Division 2, Group C&D — full inside + outside:**
Starting at **$9,000** for 8,000 BTU, approximately **$10,000** for 3-ton units

**Division 1 modifications:**
Add **20–40%** over Division 2 pricing for the same unit size

**5-ton units with full modification:**
Approximately **$10,000–$12,000+** depending on classification and site requirements
...
See our [full pricing guide](/explosion-proof-air-conditioner-cost/) for a complete breakdown of what drives cost.
...
**Bard wall-mount vs. mini split:** [Mini splits](/explosion-proof-mini-split/) are the most affordable explosion-proof option available today and work well for loads up to about 3 tons. The difference is that mini splits require an indoor evaporator head mounted on a wall or ceiling inside the space. Bard wall-mounts are completely self-contained on the exterior — nothing inside except supply and return air openings. If interior space is at a premium, choose a Bard. If you have wall or ceiling space available and want the lowest cost, choose a mini split.

**Bard wall-mount vs. split system:** Bard units are self-contained and simpler to install. [Split systems](/explosion-proof-split-system/) are necessary when the cooling load exceeds 5 tons or when wall penetration for a self-contained unit is not feasible. Split systems cost more due to additional components and more complex installation.

**Bard wall-mount vs. pressurization:** For a single control room or small shelter, a Bard wall-mount is almost always the more practical and less expensive option. [Pressurization](/pressurization-explosion-proof-buildings/) becomes the better choice for large buildings where explosion-proofing all interior equipment would be cost-prohibitive.
