...
Mini splits have become the most affordable way to put explosion-proof cooling into a hazardous location. They have effectively replaced [window units](/explosion-proof-window-air-conditioner/) as the budget-friendly entry point for classified spaces — delivering reliable cooling at a price point that makes compliant HVAC accessible for small enclosures, shelters, and control rooms.
...
We modify mini splits from major manufacturers to meet your exact hazardous location classification — [Class 1](/class-1-division-2/) or [Class 2](/class-2-division-1/), [Division 1](/class-1-division-1/) or Division 2, any group. Each section is independently rated to match the classification on its side of the wall.

![Mini split indoor evaporator head mounted high on a wall — compact, out of the way, and effective](/images/site/mini-split-indoor.jpg)
...
**If interior space is truly at a premium** — for example, a tightly packed MCC building where every wall is occupied by equipment — a [Bard wall-mount unit](/explosion-proof-bard-air-conditioner/) is the better choice. Bard wall-mounts are completely self-contained on the exterior of the building. You only need to cut a supply and return air opening through the wall for air circulation. Nothing protrudes into the interior space.

![Mini split outdoor condenser unit — mounts on exterior wall, rooftop, or ground pad](/images/site/mini-split-outdoor.jpg)
...
- **[Class 1, Division 2, Groups C & D](/class-1-division-2/)** — the most common configuration for refineries, petrochemical facilities, and chemical plants
- **[Class 1, Division 1, Groups C & D](/class-1-division-1/)** — for areas where flammable gases are present continuously or under normal operating conditions
- **[Class 2, Division 1 or 2, Groups E, F, G](/class-2-division-1/)** — for combustible dust environments including grain handling, pharmaceutical manufacturing, and mining
...
Starting at approximately **$6,700** for smaller units, scaling with capacity.

**Class 1, Division 2, Group C&D — full indoor + outdoor modification:**
Starting at approximately **$9,000+** depending on capacity and configuration.
...
**Choose a [Bard wall-mount](/explosion-proof-bard-air-conditioner/) if:**
...
Mini splits and [full split systems](/explosion-proof-split-system/) both separate the indoor and outdoor components, but they serve different applications:
...
- [Explosion Proof Bard Air Conditioners](/explosion-proof-bard-air-conditioner/) — wall-mount units, completely self-contained on the exterior
- [Explosion Proof Split Systems](/explosion-proof-split-system/) — for higher capacity requirements
