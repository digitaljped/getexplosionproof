...
schema:
  ...
  "mainEntity":
    - "@type": "Question"
      "name": "What hazardous location classifications are common in chemical plants?"
      "acceptedAnswer":
        "@type": "Answer"
        "text": "Chemical plants span the full range of NEC classifications — Class 1 for flammable solvents (Groups A through D depending on the specific chemical), and Class 2 for combustible powder environments like API processing (Group G). Division 1 or 2 depends on whether the hazard is present under normal or abnormal conditions."
    - "@type": "Question"
      "name": "Can you modify air conditioners for Group A or Group B chemicals?"
      "acceptedAnswer":
        "@type": "Answer"
        "text": "We can modify units for Group B (hydrogen, ethylene oxide) applications, though these require higher-rated motors and enclosures that add cost. We do not currently offer Group A (acetylene) modifications due to the extreme scarcity of Group A rated motors."
    - "@type": "Question"
      "name": "How is chemical plant explosion-proof HVAC different from oil and gas?"
      "acceptedAnswer":
        "@type": "Answer"
        "text": "Chemical plants often handle dozens of different materials on one site, each with different ignition characteristics and group classifications. Oil refineries are predominantly Class 1, Division 2, Groups C and D. Chemical plants may require Groups A through G across different areas, making classification analysis more complex and requiring more upfront engineering conversation."
---
...
![Chemical processing facility on the waterfront](/images/site/hazardous-location.jpg)
...
- [Class 1, Division 1 Explained](/class-1-division-1/) — for continuously hazardous chemical processing areas
